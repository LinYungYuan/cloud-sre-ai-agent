...
- Angular 不建立 SSE、WebSocket 或其他長連線；使用者重新整理畫面取得最新資料。
...
2. **Pub/Sub Emulator 與 RCA Worker**：官方 Emulator、訊息契約、worker lifecycle、ADK/MCP、evidence、report 與 conversation jobs。
